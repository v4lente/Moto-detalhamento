...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      locale={ptBR}
      className={cn(
        "bg-background group/calendar p-0.5 sm:p-3 [--cell-size:1.25rem] sm:[--cell-size:2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent text-[10px] sm:text-base",
